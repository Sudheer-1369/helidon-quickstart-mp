...
/**
 * BigDecimal represents an immutable arbitrary-precision signed decimal number. We use BigDecimal
 * for high-precision arithmetic. We also use it for calculations requiring control over scale and
 * rounding off behavior
 */
public class BigDecimalPractice {
  public static void main(String[] args) {
    ...
    /**
     * Another way of creating a BigDecimal is to use static method valueOf present in the
     * BigDecimal
     */
