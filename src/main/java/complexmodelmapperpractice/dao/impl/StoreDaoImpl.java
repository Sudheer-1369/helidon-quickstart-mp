...
public class StoreDaoImpl implements StoreDao {
  ...
  public TraStore addStore(TraStore traStore) throws DaoException {
    ...
    try {
      ...
      throw new DaoException(
          "Exception Occurred while adding the Store " + e.getMessage(), e.getCause());
    } finally {
      entityManager.close();
    }
  ...
  public List<TraStore> getAllTraStores(int page, List<String> params) throws DaoException {
    ...
    try {
      ...
      throw new DaoException(
          "Exception Occurred while retrieving the list of Stores" + e.getMessage(), e.getCause());
    } finally {
      entityManager.close();
    }
    ...
    try {
      ...
      traStore =
          (TraStore)
              entityManager
                  .createNativeQuery(
                      "SELECT * FROM usersdb.TRA_STORE where CODE = :CODE", TraStore.class)
      ...
      throw new DaoException(
          "Exception Occurred while fetching the Store with code " + e.getMessage(), e.getCause());
    } finally {
      entityManager.close();
    }
  ...
  public void deleteStore(long id) throws DaoException {
    ...
    try {
      ...
      throw new DaoException(
          "Exception Occurred while deleting the Store" + e.getMessage(), e.getCause());
    } finally {
      entityManager.close();
    }
  }
