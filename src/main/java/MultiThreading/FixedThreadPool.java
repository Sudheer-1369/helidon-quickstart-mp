...
/**
 * This code shows the work of newFixedThreadPool with size fixed which means the number of threads
 * is fixed and the others threads has to wait till one of the thread is released.
 */
