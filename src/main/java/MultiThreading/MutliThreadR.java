...
//        MultiThreadDemoR mdr = new MultiThreadDemoR();
        // We can share a single instance of the object implementing the runnable interface and it works fine but issue only comes when there exists any static variables
        for (int i = 0; i < n; i++) {
