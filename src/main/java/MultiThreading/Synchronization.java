...
class Sender {
    ...
    public void send(String msg) {
        synchronized (this) {  // instead we can make the method syncronized but that effects the performance and need to decide based on the situation.
            try {
                Thread.sleep(1000);
...
public class Synchronization {
    ...
    public static void main(String[] args) {
        ...
        Thread thread1 = new Thread(new SyncSend(sender, "Mounika"));
