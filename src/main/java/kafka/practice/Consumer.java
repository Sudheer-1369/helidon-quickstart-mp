...
public class Consumer {
    public static void main(String[] args) throws InterruptedException {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, consumerGroupId); //This consumer group might not present in the apache kafka server so we need to set the offset point from where the consumer group need to consume
