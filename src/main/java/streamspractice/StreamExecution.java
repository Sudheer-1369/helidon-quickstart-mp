...
public class StreamExecution {
  ...
  //    Let’s consider the following scenario, where we have been asked to give a list with those
  // employees with salaries below $80,000 and
  //    update their salaries with a 5% increase. The stream responsible for doing that would be the
  // one shown below:
  public static void main(String[] args) {
    ...
    employeeList.stream()
        .map(e -> new Employee("sudheer", 24, 11, "decs"))
