...
//        return configSource.size() > 0 ? configSource.get(0) :
// EmptyConfigSource.EMPTY_CONFIG_SOURCE;
//    }
//
//    /**
//     * Takes the {@code config} and registers it with the {@link ConfigProviderResolver}. If this
//     * already holds a dynamic configuration, it merges the {@code config} with the existing
// dynamic
//     * configuration.
//     *
...
//        var dynamicConfigSources = StreamSupport.stream(config.getConfigSources().spliterator(),
// false);
//
...
//                .getBuilder()
//                .withSources(allConfigSources.collect(Collectors.toList()).toArray(new
// ConfigSource[0]))
//                .build();
//    }
// }
