...
public class StudentMain {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (Jsonb jsonb = JsonbBuilder.create()) {
      ...
      logger.log(
          Logger.Level.INFO,
          String.format("The Json representation of the student object is %s", jsonStudent));

      Student student1 = jsonb.fromJson(jsonStudent, Student.class);

      logger.log(
          Logger.Level.INFO, String.format("The Student representation from json is %s", student1));
    }

    try (Jsonb jsonb = JsonbBuilder.create()) {
      Student student = new Student(motLastName, "Sudheer", 25, 20, "12-A");
      Student student1 = new Student("DECS", "Sudheer", 24, 20, "12-A");
      ...
      logger.log(
          Logger.Level.INFO, String.format("The Json rep of student list is %s", jsonStudentArray));
