...
public class SimpleExample {
    ...
    @Test
    @DisplayName("Should check if the passed string starts and ends with the provided strings/characters")
    void simpleTest() {

        assertThat("The Lord of Rings").isNotNull().startsWithIgnoringCase("the").endsWith("Rings").contains("Lord").containsAnyOf("Lord", "of");
    }
    ...
    void testAddDescriptionIncaseOfError() {
        String str = "Sudheer";
        assertThat(str).as("Check if the name is %s or not : ", str).isEqualTo("Mounika");
    }
...
//        Assertions.setPrintAssertionsDescription(true);
        ...
        Consumer<Description> descriptor = description -> {
