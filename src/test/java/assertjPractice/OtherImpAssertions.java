...
public class OtherImpAssertions {
    ...
    void testOtherAssertions(){
        ...
        assertThat(arrayList).first(as(InstanceOfAssertFactories.STRING)).startsWith("Sud").isEqualTo("Sudheer");
        assertThat(arrayList).last(as(STRING)).isEqualTo("Venkat");
        assertThat(arrayList).element(1,as(STRING)).isEqualTo("Mounika");
        ...
        assertThat(arrayList).filteredOn(d->d.contains("a")).containsExactly("Mounika","Manoja","Venkat");
        ...
        assertThat(employees).filteredOn(d->d.getSalary()>10).containsExactly(employee,employee1,employee2,employee3);
        assertThat(employees).filteredOn("age",not(24)).containsExactly(employee1,employee2,employee3);
